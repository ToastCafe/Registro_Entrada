...
const obtener_empleados = async () => {
  try {
    ...
    const empleadosFiltrados = data.filter((empleado: empleado) => empleado.sede === "AZ")
    ...
    <UModal v-model="isOpen" prevent-close>
      <UCard :ui="{ ring: '', divide: 'divide-y divide-gray-100 dark:divide-gray-800' }">
        ...
        <template #header>
          ...
          <div class="mt-10">
            <UFormGroup v-slot="{ error }" label="Cedula"
              :error="errorCedula === 'red' && 'Cédula no encontrada o usted ya se encuentra registrado...'">
